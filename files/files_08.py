...
def create_file(file):
    ...
    info_product = [
        ['Ручка', '1 рубль 5 копеек', '50', 'гелевая синего цвета'],
        ['Тетрадь в клетку', '3 рубля', '200', 'в мелкую клетку'],
        ['Ластик', '50 копеек', '700', 'твердый']
    ]
    csv_utils.write(file, title, info_product)


def new_poz(text):
    new_product = ['Замазка', '80 копеек', '500', '500мл']
